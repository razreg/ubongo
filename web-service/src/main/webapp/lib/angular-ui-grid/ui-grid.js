    ...
    getMenuItems: function( $scope ) {
      ...
      if ( $scope.grid.options.gridMenuCustomItems ){
        if ( !angular.isArray( $scope.grid.options.gridMenuCustomItems ) ){ 
          gridUtil.logError( 'unitGridOptions.gridMenuCustomItems must be an array, and is not');
        } else {
...
.factory('Grid', ['$q', '$compile', '$parse', 'gridUtil', 'uiGridConstants', 'GridOptions', 'GridColumn', 'GridRow', 'GridApi', 'rowSorter', 'rowSearcher', 'GridRenderContainer', '$timeout','ScrollEvent',
   ...
   * @param {function(colDef, col, unitGridOptions)} columnBuilder function to be called
   */
   ...
   * @param {function(colDef, col, unitGridOptions)} rowBuilder function to be called
   */
   ...
   * @methodOf ui.grid.class:Grid
   * @description When the build creates rows from unitGridOptions.data, the rowBuilders will be called to add
   * additional properties to the row.
   * @param {function(row, unitGridOptions)} rowBuilder function to be called
   */
 ...
 */
   ...
   * @param {object} rowEntity the unitGridOptions.data array element instance
   ...
   * are identified using the unitGridOptions.rowEquality function
   */
 ...
 */
  ...
  Grid.prototype.redrawInPlace = function redrawInPlace(rowsAdded) {
     ...
     * @description Scroll the grid such that the specified
     * row and column is in view
     * @param {object} rowEntity unitGridOptions.data[] array instance to make visible
     * @param {object} colDef to make visible
     * @returns {promise} a promise that is resolved after any scrolling is finished
     */
    ...
    function (gridUtil, uiGridConstants, uiGridCellNavConstants, $q, UiGridCellNav, ScrollEvent) {
      ...
      var service = {
          ...
          var publicApi = {
            ...
            methods: {
              cellNav: {
                 ...
                 * to that cell
                 * @param {object} rowEntity unitGridOptions.data[] array instance to make visible and set focus
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           */
          unitGridOptions.modifierKeysToMultiSelectCells = unitGridOptions.modifierKeysToMultiSelectCells === true;
         ...
         * from gridApi.grid
         * @param {object} rowEntity unitGridOptions.data[] array instance to make visible and set focus to
    ...
    function ($q, uiGridConstants, gridUtil) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *  </pre>
           */
          unitGridOptions.cellEditableCondition = unitGridOptions.cellEditableCondition === undefined ? true : unitGridOptions.cellEditableCondition;
          ...
          unitGridOptions.enableCellEditOnFocus = unitGridOptions.enableCellEditOnFocus === undefined ? false : unitGridOptions.enableCellEditOnFocus;
        },
        ...
        editColumnBuilder: function (colDef, col, gridOptions) {
           ...
           */
          colDef.enableCellEdit = colDef.enableCellEdit === undefined ? (unitGridOptions.enableCellEdit === undefined ?
            (colDef.type !== 'object') : unitGridOptions.enableCellEdit) : colDef.enableCellEdit;
           ...
           *  </pre>
           */
          colDef.cellEditableCondition = colDef.cellEditableCondition === undefined ? unitGridOptions.cellEditableCondition :  colDef.cellEditableCondition;
          ...
          if (colDef.enableCellEdit) {
            colDef.editableCellTemplate = colDef.editableCellTemplate || unitGridOptions.editableCellTemplate || 'ui-grid/cellEditor';
           ...
           */
            //enableCellEditOnFocus can only be used if cellnav module is used
          colDef.enableCellEditOnFocus = colDef.enableCellEditOnFocus === undefined ? unitGridOptions.enableCellEditOnFocus : colDef.enableCellEditOnFocus;
    ...
    function ($q, uiGridExporterConstants, gridUtil, $compile, $interval, i18nService) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           * <br/>Defaults to false
           */
          unitGridOptions.exporterSuppressMenu = unitGridOptions.exporterSuppressMenu === true;
          /**
           * @ngdoc object
           ...
           */
          unitGridOptions.exporterMenuLabel = unitGridOptions.exporterMenuLabel ? unitGridOptions.exporterMenuLabel : 'Export';
          /**
           * @ngdoc object
           ...
           * </pre>
           */
          unitGridOptions.exporterSuppressColumns = unitGridOptions.exporterSuppressColumns ? unitGridOptions.exporterSuppressColumns : [];
          /**
           * @ngdoc object
           ...
           * <br/>Defaults to ','
           */
          unitGridOptions.exporterCsvColumnSeparator = unitGridOptions.exporterCsvColumnSeparator ? unitGridOptions.exporterCsvColumnSeparator : ',';
          /**
           * @ngdoc object
           ...
           */
          unitGridOptions.exporterCsvFilename = unitGridOptions.exporterCsvFilename ? unitGridOptions.exporterCsvFilename : 'download.csv';
          /**
           * @ngdoc object
           ...
           */
          unitGridOptions.exporterPdfFilename = unitGridOptions.exporterPdfFilename ? unitGridOptions.exporterPdfFilename : 'download.pdf';
          /**
           * @ngdoc object
           ...
           * <br/>Defaults to false
           */
          unitGridOptions.exporterOlderExcelCompatibility = unitGridOptions.exporterOlderExcelCompatibility === true;
          /**
           * @ngdoc object
           ...
           * </pre>
           */
          unitGridOptions.exporterPdfDefaultStyle = unitGridOptions.exporterPdfDefaultStyle ? unitGridOptions.exporterPdfDefaultStyle : { fontSize: 11 };
          /**
           * @ngdoc object
           ...
           * </pre>
           */
          unitGridOptions.exporterPdfTableStyle = unitGridOptions.exporterPdfTableStyle ? unitGridOptions.exporterPdfTableStyle : { margin: [0, 5, 0, 15] };
          /**
           * @ngdoc object
           ...
           * </pre>
           */
          unitGridOptions.exporterPdfTableHeaderStyle = unitGridOptions.exporterPdfTableHeaderStyle ? unitGridOptions.exporterPdfTableHeaderStyle : { bold: true, fontSize: 12, color: 'black' };
          /**
           * @ngdoc object
           ...
           * </pre>
           */
          unitGridOptions.exporterPdfHeader = unitGridOptions.exporterPdfHeader ? unitGridOptions.exporterPdfHeader : null;
          /**
           * @ngdoc object
           ...
           * </pre>
           */
          unitGridOptions.exporterPdfFooter = unitGridOptions.exporterPdfFooter ? unitGridOptions.exporterPdfFooter : null;
          /**
           * @ngdoc object
           ...
           */
          unitGridOptions.exporterPdfOrientation = unitGridOptions.exporterPdfOrientation ? unitGridOptions.exporterPdfOrientation : 'landscape';
          /**
           * @ngdoc object
           ...
           * <br/>Defaults to A4
           */
          unitGridOptions.exporterPdfPageSize = unitGridOptions.exporterPdfPageSize ? unitGridOptions.exporterPdfPageSize : 'A4';
          /**
           * @ngdoc object
           ...
           */
          unitGridOptions.exporterPdfMaxGridWidth = unitGridOptions.exporterPdfMaxGridWidth ? unitGridOptions.exporterPdfMaxGridWidth : 720;
          /**
           * @ngdoc object
           ...
           */
          unitGridOptions.exporterMenuAllData = unitGridOptions.exporterMenuAllData !== undefined ? unitGridOptions.exporterMenuAllData : true;
           ...
           */
          unitGridOptions.exporterMenuCsv = unitGridOptions.exporterMenuCsv !== undefined ? unitGridOptions.exporterMenuCsv : true;
           ...
           */
          unitGridOptions.exporterMenuPdf = unitGridOptions.exporterMenuPdf !== undefined ? unitGridOptions.exporterMenuPdf : true;
           ...
           * </pre>
           */
          unitGridOptions.exporterPdfCustomFormatter = ( unitGridOptions.exporterPdfCustomFormatter && typeof( unitGridOptions.exporterPdfCustomFormatter ) === 'function' ) ? unitGridOptions.exporterPdfCustomFormatter : function (docDef ) { return docDef; };
           ...
           * </pre>
           */
          unitGridOptions.exporterHeaderFilterUseName = unitGridOptions.exporterHeaderFilterUseName === true;
           ...
           * </pre>
           */
          unitGridOptions.exporterFieldCallback = unitGridOptions.exporterFieldCallback ? unitGridOptions.exporterFieldCallback : function(grid, row, col, value ) { return value; };
           ...
           * </pre>
           */
          unitGridOptions.exporterAllDataFn = unitGridOptions.exporterAllDataFn ? unitGridOptions.exporterAllDataFn : null;
           ...
           * </pre>
           */
          if ( unitGridOptions.exporterAllDataFn == null && unitGridOptions.exporterAllDataPromise ) {
            unitGridOptions.exporterAllDataFn = unitGridOptions.exporterAllDataPromise;
          }
        },
  ...
  function ($q, uiGridGroupingConstants, gridUtil, rowSorter, GridRow, gridClassFactory, i18nService, uiGridConstants, uiGridTreeBaseService) {
    ...
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         *  <br/>Defaults to true
         */
        unitGridOptions.enableGrouping = unitGridOptions.enableGrouping !== false;
         ...
         */
        unitGridOptions.groupingShowCounts = unitGridOptions.groupingShowCounts !== false;
         ...
         *  <br/>Defaults to "Null"
         */
        unitGridOptions.groupingNullLabel = typeof(unitGridOptions.groupingNullLabel) === 'undefined' ? 'Null' : unitGridOptions.groupingNullLabel;
         ...
         *  <br/>Defaults to false
         */
        unitGridOptions.enableGroupHeaderSelection = unitGridOptions.enableGroupHeaderSelection === true;
      },
      ...
      groupingColumnBuilder: function (colDef, col, gridOptions) {
        ...
        if ( col.colDef.groupingShowAggregationMenu !== false ){
          ...
          angular.forEach(unitGridOptions.treeCustomAggregations, function(aggregationDef, name){
       ...
       * @param {string} one of the recognised types from uiGridGroupingConstants or one of the custom aggregations from unitGridOptions
       */
    ...
    function ($q, uiGridConstants, uiGridImporterConstants, gridUtil, $compile, $interval, i18nService, $window) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *
           */
          if (unitGridOptions.enableImporter  || unitGridOptions.enableImporter === undefined) {
            if ( !($window.hasOwnProperty('File') && $window.hasOwnProperty('FileReader') && $window.hasOwnProperty('FileList') && $window.hasOwnProperty('Blob')) ) {
              ...
              unitGridOptions.enableImporter = false;
            } else {
              unitGridOptions.enableImporter = true;
            }
          } else {
            unitGridOptions.enableImporter = false;
          }
           ...
           *
           */
          unitGridOptions.importerProcessHeaders = unitGridOptions.importerProcessHeaders || service.processHeaders;
           ...
           * <pre>
           *      unitGridOptions.importerHeaderFilter: function( displayName ) {
           ...
           * or:
           * <pre>
           *      unitGridOptions.importerHeaderFilter: $translate.instant
           * </pre>
           * @param {string} displayName the displayName that we'd like to translate
           * @returns {string} the translated name
           *
           */
          unitGridOptions.importerHeaderFilter = unitGridOptions.importerHeaderFilter || function(displayName ) { return displayName; };
           ...
           *
           */
          if ( !unitGridOptions.importerErrorCallback ||  typeof(unitGridOptions.importerErrorCallback) !== 'function' ){
            delete unitGridOptions.importerErrorCallback;
          }
           ...
           *
           */
          if ( unitGridOptions.enableImporter === true && !unitGridOptions.importerDataAddCallback ) {
           ...
           *
           */
          unitGridOptions.importerShowMenu = unitGridOptions.importerShowMenu !== false;
           ...
           * </pre>
           */
          unitGridOptions.importerObjectCallback = unitGridOptions.importerObjectCallback || function(grid, newObject ) { return newObject; };
        },
         ...
         * into a set of objects.  Uses the provided `unitGridOptions.importerNewObject`
         * to create the objects, and maps the header row into the individual columns
         * using either `unitGridOptions.importerProcessHeaders`, or by using a native method
  ...
  module.service('uiGridInfiniteScrollService', ['gridUtil', '$compile', '$timeout', 'uiGridConstants', 'ScrollEvent', '$q', function (gridUtil, $compile, $timeout, uiGridConstants, ScrollEvent, $q) {
    ...
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         *  <br/>Defaults to true
         */
        unitGridOptions.enableInfiniteScroll = unitGridOptions.enableInfiniteScroll !== false;
         ...
         * <br> Defaults to 20
         */
        unitGridOptions.infiniteScrollRowsFromEnd = unitGridOptions.infiniteScrollRowsFromEnd || 20;
         ...
         * <br> Defaults to false
         */
        unitGridOptions.infiniteScrollUp = unitGridOptions.infiniteScrollUp === true;
         ...
         * <br> Defaults to true
         */
        unitGridOptions.infiniteScrollDown = unitGridOptions.infiniteScrollDown !== false;
      },
  ...
  module.service('uiGridMoveColumnService', ['$q', '$timeout', '$log', 'ScrollEvent', 'uiGridConstants', 'gridUtil', function ($q, $timeout, $log, ScrollEvent, uiGridConstants, gridUtil) {
    ...
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         */
        unitGridOptions.enableColumnMoving = unitGridOptions.enableColumnMoving !== false;
      },
      movableColumnBuilder: function (colDef, col, gridOptions) {
         ...
         */
        colDef.enableColumnMoving = colDef.enableColumnMoving === undefined ? unitGridOptions.enableColumnMoving
    ...
    function (gridUtil) {
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           */
          unitGridOptions.enablePagination = unitGridOptions.enablePagination !== false;
          /**
           * @ngdoc property
           ...
           */
          unitGridOptions.enablePaginationControls = unitGridOptions.enablePaginationControls !== false;
          /**
           * @ngdoc property
           ...
           */
          unitGridOptions.useExternalPagination = unitGridOptions.useExternalPagination === true;
          /**
           * @ngdoc property
           * @name totalItems
           * @propertyOf ui.grid.pagination.api:GridOptions
           ...
           */
          if (gridUtil.isNullOrUndefined(unitGridOptions.totalItems)) {
            unitGridOptions.totalItems = 0;
          }
          /**
           * @ngdoc property
           ...
           */
          if (gridUtil.isNullOrUndefined(unitGridOptions.paginationPageSizes)) {
            unitGridOptions.paginationPageSizes = [250, 500, 1000];
          }
          /**
           * @ngdoc property
           ...
           */
          if (gridUtil.isNullOrUndefined(unitGridOptions.paginationPageSize)) {
            if (unitGridOptions.paginationPageSizes.length > 0) {
              unitGridOptions.paginationPageSize = unitGridOptions.paginationPageSizes[0];
            } else {
              unitGridOptions.paginationPageSize = 0;
            }
          }
          /**
           * @ngdoc property
           ...
           */
          if (gridUtil.isNullOrUndefined(unitGridOptions.paginationCurrentPage)) {
            unitGridOptions.paginationCurrentPage = 1;
          }
           ...
           */
          if (gridUtil.isNullOrUndefined(unitGridOptions.paginationTemplate)) {
            unitGridOptions.paginationTemplate = 'ui-grid/pagination';
          }
        },
        /**
         * @ngdoc method
  ...
  module.service('uiGridPinningService', ['gridUtil', 'GridRenderContainer', 'i18nService', 'uiGridPinningConstants', function (gridUtil, GridRenderContainer, i18nService, uiGridPinningConstants) {
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         *  <br/>Defaults to true
         */
        unitGridOptions.enablePinning = unitGridOptions.enablePinning !== false;

      },

      pinningColumnBuilder: function (colDef, col, gridOptions) {
        //default to true unless unitGridOptions or colDef is explicitly false
         ...
         *  <br/>Defaults to true
         */
        colDef.enablePinning = colDef.enablePinning === undefined ? unitGridOptions.enablePinning : colDef.enablePinning;
    ...
    function (gridUtil, $q, $timeout) {
      ...
      var service = {
        defaultGridOptions: function(gridOptions){
           ...
           *  <br/>Defaults to true
           */
          unitGridOptions.enableColumnResizing = unitGridOptions.enableColumnResizing !== false;

          //legacy support
          //use old name if it is explicitly false
          if (unitGridOptions.enableColumnResize === false){
            unitGridOptions.enableColumnResizing = false;
          }
        },
        ...
        colResizerColumnBuilder: function (colDef, col, gridOptions) {
           ...
           */
          //default to true unless unitGridOptions or colDef is explicitly false
          colDef.enableColumnResizing = colDef.enableColumnResizing === undefined ? unitGridOptions.enableColumnResizing : colDef.enableColumnResizing;
    ...
    function ($q, uiGridSaveStateConstants, gridUtil, $compile, $interval, uiGridConstants ) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveWidths = unitGridOptions.saveWidths !== false;
          /**
           * @ngdoc object
           * @name saveOrder
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveOrder = unitGridOptions.saveOrder !== false;
          /**
           * @ngdoc object
           * @name saveScroll
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to false
           */
          unitGridOptions.saveScroll = unitGridOptions.saveScroll === true;
          /**
           * @ngdoc object
           * @name saveFocus
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           */
          unitGridOptions.saveFocus = unitGridOptions.saveScroll !== true && unitGridOptions.saveFocus !== false;
          /**
           * @ngdoc object
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveVisible = unitGridOptions.saveVisible !== false;
          /**
           * @ngdoc object
           * @name saveSort
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveSort = unitGridOptions.saveSort !== false;
          /**
           * @ngdoc object
           * @name saveFilter
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveFilter = unitGridOptions.saveFilter !== false;
          /**
           * @ngdoc object
           * @name saveSelection
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveSelection = unitGridOptions.saveSelection !== false;
          /**
           * @ngdoc object
           * @name saveGrouping
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveGrouping = unitGridOptions.saveGrouping !== false;
          /**
           * @ngdoc object
           ...
           * <br/>Defaults to false
           */
          unitGridOptions.saveGroupingExpandedStates = unitGridOptions.saveGroupingExpandedStates === true;
          /**
           * @ngdoc object
           * @name savePinning
           * @propertyOf ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.savePinning = unitGridOptions.savePinning !== false;
          /**
           * @ngdoc object
           * @name saveTreeView
           * @propertyOf  ui.grid.saveState.api:GridOptions
           ...
           * <br/>Defaults to true
           */
          unitGridOptions.saveTreeView = unitGridOptions.saveTreeView !== false;
        },
    ...
    function ($q, $templateCache, uiGridSelectionConstants, gridUtil) {
      ...
      var service = {
          ...
          var publicApi = {
            ...
            methods: {
              selection: {
                 ...
                 * @param {object} rowEntity unitGridOptions.data[] array instance
                 * @param {Event} event object if raised from an event
                 */
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *  <br/>Defaults to true
           */
          unitGridOptions.enableRowSelection = unitGridOptions.enableRowSelection !== false;
          /**
           *  @ngdoc object
           *  @name multiSelect
           *  @propertyOf  ui.grid.selection.api:GridOptions
           ...
           *  <br/>Defaults to true
           */
          unitGridOptions.multiSelect = unitGridOptions.multiSelect !== false;
          /**
           *  @ngdoc object
           *  @name noUnselect
           *  @propertyOf  ui.grid.selection.api:GridOptions
           ...
           *  <br/>Defaults to false
           */
          unitGridOptions.noUnselect = unitGridOptions.noUnselect === true;
          /**
           *  @ngdoc object
           ...
           *  <br/>Defaults to false
           */
          unitGridOptions.modifierKeysToMultiSelect = unitGridOptions.modifierKeysToMultiSelect === true;
          /**
           *  @ngdoc object
           ...
           *  <br/>Defaults to true
           */
          unitGridOptions.enableRowHeaderSelection = unitGridOptions.enableRowHeaderSelection !== false;
          /**
           *  @ngdoc object
           ...
           */
          if ( typeof(unitGridOptions.enableFullRowSelection) === 'undefined' ){
            unitGridOptions.enableFullRowSelection = !unitGridOptions.enableRowHeaderSelection;
          }
          /**
           *  @ngdoc object
           ...
           *  <br/>Defaults to true
           */
          unitGridOptions.enableSelectAll = unitGridOptions.enableSelectAll !== false;
          /**
           *  @ngdoc object
           ...
           *  <br/>Defaults to true
           */
          unitGridOptions.enableSelectionBatchEvent = unitGridOptions.enableSelectionBatchEvent !== false;
          /**
           *  @ngdoc object
           ...
           *  <br/>Defaults to 30px
           */
          unitGridOptions.selectionRowHeaderWidth = angular.isDefined(unitGridOptions.selectionRowHeaderWidth) ? unitGridOptions.selectionRowHeaderWidth : 30;
           ...
           */
          unitGridOptions.enableFooterTotalSelected = unitGridOptions.enableFooterTotalSelected !== false;
          ...
          unitGridOptions.isRowSelectable = angular.isDefined(unitGridOptions.isRowSelectable) ? unitGridOptions.isRowSelectable : angular.noop;
        },
  ...
  function ($q, uiGridTreeBaseConstants, gridUtil, GridRow, gridClassFactory, i18nService, uiGridConstants, rowSorter) {
    ...
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         *  <br/>Defaults to 30
         */
        unitGridOptions.treeRowHeaderBaseWidth = unitGridOptions.treeRowHeaderBaseWidth || 30;
         ...
         *  <br/>Defaults to 10
         */
        unitGridOptions.treeIndent = unitGridOptions.treeIndent || 10;
         ...
         *  <br/>Defaults to true
         */
        unitGridOptions.showTreeRowHeader = unitGridOptions.showTreeRowHeader !== false;
         ...
         */
        unitGridOptions.showTreeExpandNoChildren = unitGridOptions.showTreeExpandNoChildren !== false;
         ...
         *  <br/>Defaults to true
         */
        unitGridOptions.treeRowHeaderAlwaysVisible = unitGridOptions.treeRowHeaderAlwaysVisible !== false;
       ...
       *            aggregation.count = (aggregation.count || 1) + 1;
         ...
         *  <br/>Defaults to {}
         */
        unitGridOptions.treeCustomAggregations = unitGridOptions.treeCustomAggregations || {};
      },
      ...
      treeBaseColumnBuilder: function (colDef, col, gridOptions) {
        ...
        if ( typeof(colDef.treeAggregationType) !== 'undefined' ){
          ...
          if ( typeof(unitGridOptions.treeCustomAggregations[colDef.treeAggregationType]) !== 'undefined' ){
            col.treeAggregationFn = unitGridOptions.treeCustomAggregations[colDef.treeAggregationType].aggregationFn;
            col.treeAggregationFinalizerFn = unitGridOptions.treeCustomAggregations[colDef.treeAggregationType].finalizerFn;
            col.treeAggregation.label = unitGridOptions.treeCustomAggregations[colDef.treeAggregationType].label;
  ...
  function ($q, uiGridTreeViewConstants, uiGridTreeBaseConstants, uiGridTreeBaseService, gridUtil, GridRow, gridClassFactory, i18nService, uiGridConstants) {
    ...
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         *  <br/>Defaults to true
         */
        unitGridOptions.enableTreeView = unitGridOptions.enableTreeView !== false;
